...
public class mason1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mason1);
        ...
        service_person = intent.getStringExtra("W1");
    ...
    private DatePickerDialog.OnDateSetListener dpickerlistner = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker datePicker, int i, int i1, int i2) {
            ...
            day_x = i2;
            if (year_x != year_c)
                Toast.makeText(mason1.this, "INVALID DATE", Toast.LENGTH_LONG).show();
                ...
                if (day_x <= day_c)
                    ...
                    Toast.makeText(mason1.this, day_x + "/ " + month_x + "/ " + year_x, Toast.LENGTH_LONG).show();
    ...
    public void onClick(View v) {
        if(c1.isChecked())
        {
            if(services_required.equals("null"))
                services_required="Floor";
            else
                services_required=services_required+", Floor";
        }
        if(c2.isChecked())
        {
            if(services_required.equals("null"))
                services_required="Walls";
            else
                services_required=services_required+", Walls";
        }
